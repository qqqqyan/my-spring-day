...
export const BOARDS: Board[] = [
  ...
  },
  {
    ...
    name: "看见",
    nameEn: "Seeing",
    description: "把目光停下来，看见人、景、瞬间，也看见心里的回声。",
    descriptionEn: "Observation, presence, and quiet discoveries.",
    image: "/welcome.jpg",
    overlay: "from-cyan-950/60 via-sky-900/40 to-indigo-950/70",
    icon: Eye,
  },
  {
    slug: "psychology",
